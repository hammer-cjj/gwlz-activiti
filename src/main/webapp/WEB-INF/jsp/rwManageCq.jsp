...
<table id="dg" title="任务管理" 
   ...
   url="${pageContext.request.contextPath}/rw/list" fit="true" toolbar="#tb">
   <thead>
   	<tr>
...
<!-- 查看任务详细开始 -->
<div id="dd" class="easyui-dialog" style="width:600px;height:400px;" closed="true">   
	...
	<form id="fm" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				...
				<td>
					<font color="red">&nbsp;*</font>
					<input type="checkbox" name="zyFlagStr" style="vertical-align:middle;"/>重要任务
				</td>
			</tr>
